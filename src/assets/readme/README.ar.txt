...
> تم التحديث: 11 أغسطس 2026. تستمر عمليات التثبيت الطويلة في الخلفية، ولكن لا يجب إيقاف ReDHawK Code بالقوة.

## ما هو الجديد

- تمت إضافة **ReDHawK AI** مباشرة أسفل الوحدة الطرفية مع مساحة عمل منفصلة وحديثة للوكيل.
...
- يتضمن ReDHawK AI اختيار المشروع لتخزين Ubuntu المنزلي أو الهاتف، والدردشة المستمرة، ومحرر نص متكامل، وقائمة ملف/مساحة عمل منزلقة.
...
- يمكن تغيير نقطة نهاية/نموذج الموفر ومجموعات الأذونات لكل أداة ووضع الموافقة والحفظ التلقائي لاحقًا من تفضيلات ReDHawK AI.
...
- تستخدم وحدة تحكم الويب الآن محرك VT الخاص بـ ReDHawK Code، والحجم الدقيق للمتصفح، والألوان ذات السمات، واختصارات الهاتف المحمول، بحيث يتم عرض OpenCode بدون عناصر ANSI.
...
اختر **ReDHawK AI** من القائمة الرئيسية، وقم بتوصيل مزود واحد وحدد مجلد المشروع. يكشف الوكيل عن هذه الأدوات على مستوى المشروع:
...
4. اضغط على **تثبيت الإعداد** واستمر في تشغيل ReDHawK Code.
5. يحتوي كل مكون على شريط التقدم المئوي الخاص به وإخراج المحطة الطرفية الخلفية.

## الوصول إلى مساحة تخزين الهاتف

قم بتشغيل هذا داخل محطة Ubuntu. يفتح ReDHawK Code إعدادات تخزين Android، وينتظر الإذن ويستمر تلقائيًا.
...
- `/hostdata`— ملفات جسر ReDHawK Code الخاصة.
...
يقوم التثبيت الأول بتنزيل نظام ملفات الجذر الرسمي البسيط ARM64. يؤدي تشغيل نفس الأمر على تثبيت ReDHawK Code Kali الأقدم إلى إصلاح المستودعات والأدوات دون تنزيل نظام الملفات الجذر مرة أخرى.
...
قم بتثبيت أحدث إصدار من ReDHawK Code APK على التطبيق الحالي. يتم تضمين جسر ARM64 PTY وإصلاحات دورة حياة الجلسة بدءًا من الإصدار 3.31 وما بعده.
