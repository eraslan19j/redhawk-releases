...
> Оновлено 11 серпня 2026 року. Тривалі встановлення працюють у фоні, але ReDHawK Code не можна примусово закривати.

## Що нового

- Одразу під Терміналом додано сучасну робочу область агента **ReDHawK AI**.
...
- Вебконсоль тепер використовує VT-рушій ReDHawK Code, точний розмір браузера, узгоджені кольори й мобільні скорочення; OpenCode відображається без артефактів ANSI.
...
- `/hostdata` — приватний міст ReDHawK Code.
